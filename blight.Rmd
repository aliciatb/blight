...
# Of the predictions, the [confusion matrix](http://en.wikipedia.org/wiki/Confusion_matrix) indicates
# **`r log_matrix[1,1]`** true positives, **`r log_matrix[2,1]`** false negatives, **`r log_matrix[1,2]`** false positives and **`r log_matrix[2,2]`** true negatives.
...
# Of the predictions, the [confusion matrix](http://en.wikipedia.org/wiki/Confusion_matrix) indicates
# **`r tree_matrix[1,1]`** true positives, **`r tree_matrix[2,1]`** false negatives, **`r tree_matrix[1,2]`** false positives and **`r tree_matrix[2,2]`** true negatives.
```
...
# Of the predictions, the [confusion matrix](http://en.wikipedia.org/wiki/Confusion_matrix) indicates
# **`r bag_matrix[1,1]`** true positives, **`r bag_matrix[2,1]`** false negatives, **`r bag_matrix[1,2]`** false positives and **`r bag_matrix[2,2]`** true negatives.
```
...
# Of the predictions, the [confusion matrix](http://en.wikipedia.org/wiki/Confusion_matrix) indicates
# **`r boost_matrix[1,1]`** true positives, **`r boost_matrix[2,1]`** false negatives, **`r boost_matrix[1,2]`** false positives and **`r boost_matrix[2,2]`** true negatives.
```
...
```{r results, message=FALSE, warning=FALSE, eval=TRUE}
# compare
